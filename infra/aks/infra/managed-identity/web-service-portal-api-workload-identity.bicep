...
param serviceAccountName string = 'web-service-portal-api'
...
resource storageBlobAdminRole 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid('ba92f5b4-2d11-453d-a403-e96b0029c9fe', serviceManagedIdentity.id, storage.id)
  scope: storage
  properties: {
...
resource keyvaultAccessPolicy 'Microsoft.KeyVault/vaults/accessPolicies@2023-07-01' = {
  ...
  properties: {
    accessPolicies: [
      {
        objectId: serviceManagedIdentity.properties.principalId
...
//   name: guid('00000000-0000-0000-0000-000000000002', serviceManagedIdentity.id, cosmosDb.id)
//   parent: cosmosDb
//   properties: {
//     principalId: serviceManagedIdentity.properties.principalId
...
output managedIdentityPrincipalId string = serviceManagedIdentity.properties.principalId
output managedIdentityClientId string = serviceManagedIdentity.properties.clientId
